...
public class GameActivity extends FragmentActivity implements RefreshInterface {
	...
	public class SectionsPagerAdapter extends FragmentPagerAdapter {
		...
		public Fragment getItem(int position) {
			...
			// args.putInt((String) getResources().getText(R.string.gameid),
			// mGameId);
			// args.putInt((String) getResources().getText(R.string.charid),
			// mCharId);
			Log.i("AlterEgo::GameActivity::getItem",
					"Spawning a new fragment with game=" + mGameId
							+ " and char=" + mCharId);
			...
			switch (position) {
			case 0:
				// CharacterFragment needs a call-back to the refresh button (in
				// case a character is added)
